...
describe('Time scale tests', function() {
	...
	it('should build ticks using days', function() {
		...
		var mockData = {
			labels: ["2019-01-01T20:00:00", "2019-01-02T21:00:00", "2019-01-03T22:00:00", "2019-01-05T23:00:00", "2019-01-07T03:00", "2019-01-08T10:00", "2019-01-10T12:00"], // days
		};
		...
		expect(scale.ticks).toEqual([ 'Dec 28, 2014', 'Jan 4, 2019', 'Jan 11, 2019' ]);
	});

	it('should build ticks using date objects', function() {
		// Helper to build date objects
		function newDateFromRef(days) {
			return moment('01/01/2019 12:00', 'DD/MM/YYYY HH:mm').add(days, 'd').toDate();
		}
	...
	it('should build ticks when the data is xy points', function() {
		...
		expect(xScale.ticks).toEqual([ 'Jan 1, 2019', 'Jan 3, 2019', 'Jan 5, 2019', 'Jan 7, 2019', 'Jan 9, 2019', 'Jan 11, 2019' ]);
	});
	...
	it('should build ticks using the config unit', function() {
		...
		var mockData = {
			labels: ["2019-01-01T20:00:00", "2019-01-02T21:00:00"], // days
		};
	...
	it('should build ticks using the config diff', function() {
		...
		var mockData = {
			labels: ["2019-01-01T20:00:00", "2019-02-02T21:00:00", "2019-02-21T01:00:00"], // days
		};
		...
		expect(scale.ticks).toEqual(['Dec 28, 2014', 'Jan 4, 2019', 'Jan 11, 2019', 'Jan 18, 2019', 'Jan 25, 2019', 'Feb 1, 2019', 'Feb 8, 2019', 'Feb 15, 2019']);
	});
	...
	it('Should use the min and max options', function() {
		...
		var mockData = {
			labels: ["2019-01-01T20:00:00", "2019-01-02T20:00:00", "2019-01-03T20:00:00"], // days
		};

		var mockContext = window.createMockContext();
		var config = Chart.helpers.clone(Chart.scaleService.getScaleDefaults('time'));
		config.time.min = "2019-01-01T04:00:00";
		config.time.max = "2019-01-05T06:00:00"
		var Constructor = Chart.scaleService.getScaleConstructor('time');
		var scale = new Constructor({
			ctx: mockContext,
			options: config, // use default config for scale
		...
		scale.update(400, 50);
		expect(scale.ticks).toEqual([ 'Jan 1, 2019', 'Jan 5, 2019' ]);
	});
	...
	it('Should use the isoWeekday option', function() {
		...
		var mockData = {
			labels: [
				"2019-01-01T20:00:00", // Thursday
				"2019-01-02T20:00:00", // Friday
				"2019-01-03T20:00:00" // Saturday
			]
		};
		...
		scale.update(400, 50);
		expect(scale.ticks).toEqual([ 'Dec 31, 2014', 'Jan 7, 2019' ]);
	});
	...
	it('should get the correct label for a data value', function() {
		...
		var xScale = chartInstance.scales.xScale0;
		expect(xScale.getLabelForIndex(0, 0)).toBe('2019-01-01T20:00:00');
		expect(xScale.getLabelForIndex(6, 0)).toBe('2019-01-10T12:00');
